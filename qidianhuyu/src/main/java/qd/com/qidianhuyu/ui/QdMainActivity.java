...
import qd.com.qidianhuyu.ali.net.NetWatchdog;
import qd.com.qidianhuyu.ali.utils.PermissionUtils;
import qd.com.qidianhuyu.fragment.MainVideoFragment;
import qd.com.qidianhuyu.fragment.MainMineFragment;
import qd.com.qidianhuyu.fragment.MainMoneyFragment;
import qd.com.qidianhuyu.ui.view.BottomBar;
import qd.com.qidianhuyu.ui.view.BottomBarTab;
...
public class QdMainActivity extends BaseActivity {
    ...
    public void initParameter() {
        ...
        BaseFragment homeFragment = findFragment(MainVideoFragment.class);
        if (homeFragment == null) {
            baseFragments[FIRST] = MainVideoFragment.newInstance();
    ...
    private static class MyNetConnectedListener implements NetWatchdog.NetConnectedListener {
        private WeakReference<QdMainActivity> weakReference;

        MyNetConnectedListener(QdMainActivity activity) {
